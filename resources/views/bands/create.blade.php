        ...
        <form action="{{ route('bands.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6 bg-gray-800 p-8 rounded-xl border border-gray-700">
            ...
            <div class="grid grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <input type="date" name="formed_at" class="w-full bg-gray-800 text-white border border-gray-700 rounded-lg p-3 text-white focus:border-indigo-500 outline-none">
                </div>
                </div>
                <div>
