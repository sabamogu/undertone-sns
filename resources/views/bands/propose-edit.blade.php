@extends('layouts.app')@section('content')
    <div class="max-w-xl mx-auto">
        ...
        <h1 class="text-white text-3xl font-bold mt-6 mb-8">バンド情報の修正を提案</h1>

        <form action="{{ route('bands.propose-edit.store', $band) }}" method="POST" enctype="multipart/form-data" class="space-y-6 bg-gray-800 p-8 rounded-xl border border-gray-700">
            @csrf 
            <div>
            ...
            <div class="grid grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <button type="button" id="add-video-btn" class="mt-3 text-sm text-indigo-400 hover:text-indigo-300 flex items-center">
                        ...
                        <p class="text-xs text-gray-500 mt-1">※Youtube動画のURLの「?」の前の11桁を入力してください</p>
                    </div>
                </div>
